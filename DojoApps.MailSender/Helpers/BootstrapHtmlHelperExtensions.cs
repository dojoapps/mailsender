...
namespace DojoApps.MailSender.Helpers
{
    public static class BootstrapHtmlHelperExtensions
    {
        ...
        public static MvcHtmlString BootstrapControlGroupFor<TModel, TProperty>(this HtmlHelper<TModel> helper, Expression<Func<TModel, TProperty>> expression, MvcHtmlString editor = null, bool usePlaceholder = false)
        {
